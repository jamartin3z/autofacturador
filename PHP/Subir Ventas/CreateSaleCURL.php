...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://autofacturador.cfdiquadrum.com.mx:8890/api/v1/order/create/',
  ...
  CURLOPT_HTTPHEADER => array(
    'Merchant: ID <MerchantID>', # ID Negocio Proporcionado por Quadrum
    'Content-Type: application/json',
    'Authorization: Token <TokenID>' #  Token Autorización
  ),
));
